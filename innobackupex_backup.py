...
db_user = "bkpuser"
db_passwd = 'xxx'
db_socket = '/tmp/mysql%s.sock' % (db_port)

# Backup options.
db_serverid = "0889036"
back = "/data/mysql/innobackupex_full"
conf = "/data/mysql/mysql%s/my%s.cnf" % (db_port, db_port)
business = "YP"
